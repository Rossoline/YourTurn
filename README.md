...
Run the SQL files from `sql/` in Supabase SQL Editor **in order**:
...
4. `sql/chats.sql` — per-user chat sessions
5. `sql/chat_migration.sql` — links messages/summaries to chats (run after chats.sql)
